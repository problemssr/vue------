...
export const reqSpu=(spuId)=>request({url:`/admin/product/getSpuById/${spuId}`,method:'get',params:{spuId}})
...
export const reqSpuImageList=(spuId)=>request({url:`/admin/product/spuImageList/${spuId}`,method:'get',params:{spuId}})
...
// /admin/product/updateSpuInfo post 修改带参（有id）
// /admin/product/saveSpuInfo post 添加带参（无id）
